...
export const constantRoutes = [
    ...
    children: [
      {
        ...
        name: 'controlcenter',
        meta: { title: '控制中心', icon: 'dashboard', affix: true }
      }
    ]
  },
  {
    ...
    children: [
      ...
      {
        path: 'directive',
        component: () => import('@/views/studentmanagement/stu-page'),
        name: 'stulist',
        meta: {
          title: '班级管理'
      ...
      {
        path: 'appealreview',
        component: () => import('@/views/studentmanagement/appealreview'),
        name: 'appealreview',
        meta: {
          title: '申诉审核'
          // if do not set roles, means: this page does not require permission
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: 'directive',
        component: () => import('@/views/storehouse/batchimport'),
        name: 'batchimport',
        meta: {
          title: '批量导入'
          // if do not set roles, means: this page does not require permission
  ...
  },
  {
    ...
    children: [
     ...
     {
       path: 'create',
       component: () => import('@/views/testpaper/createpaper'),
       name: 'createpaper',
       meta: {
         title: '创建试卷',
         // roles: ['admin'] // or you can only set roles in sub nav
